...
urlpatterns = [
    # base_views.py
    # name은 url 하드 코딩 문제를 해결하기 위해 사용하는 별칭임
    path('',
         base_views.index, name='index'),  # /pybo는 pybo.views.index 함수와 매핑됨
    path('contact',
         base_views.contact, name='contact'), # /pybo/contact는 pybo.views.contact 함수와 매핑됨
